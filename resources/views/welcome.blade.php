...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-white-100 dark:bg-white-900 sm:items-center sm:pt-0">
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
            <a href="{{ url('/home') }}" class="btn btn-primary" role="button">Play</a>
            @else
...
<body>
    <div class="card" style="width: 100rem; height:40rem;">
        <img class="card-img-top" src="https://comunidad.amena.com/t5/image/serverpage/image-id/7603iDB24A534E055A5B3/image-size/large?v=1.0&px=999" alt="Card image cap">
        <div class="card-body">
